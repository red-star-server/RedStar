...
changeling-catalog-voice-mindshield-desc = Модифицируйте собственные нейронные волны для имитации сигнала импланта защиты разума СССП, создавая видимость установленного Щита разума для сотрудников милиции. Эффект можно переключить.
