...
head-rev-role-greeting =
    ...
    Синдикат проспонсировал вас особой вспышкой, которая обращает других на вашу сторону. Осторожно, она не сработает на тех, у кого есть имплант "Щит разума", и тех, кто носит защиту для глаз. Помните, что в процессе найма члены командования и милиции проходят имплантацию "Щитом разума".
    Viva la revolución!
