...
survivor-role-greeting =
    Вы — выживший. Ваша главная задача — остаться в живых и вернуться на Генштаб.
...
wizard-role-greeting =
    ...
    Между Федерацией космических волшебников и СССП возникли противоречия. Вы были выбраны Федерацией Космических Волшебников, чтобы навестить станцию и "напомнить им", почему над заклинателями не издеваются.
