...
tips-dataset-139 = Обязательно очищайте незаконные имплантеры мылом или влажной тряпкой после их использования! Следователи могут сканировать использованные имплантеры на наличие компрометирующих ДНК-улик, но только, если они не были очищены.
