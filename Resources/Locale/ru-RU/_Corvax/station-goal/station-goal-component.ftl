...
station-goal-solar-panels =
    { "" }[bold]Второстепенная цель — постройка сети солнечных панелей.[/bold]
...
station-goal-artifacts =
    { "" }[bold]Второстепенная цель — нахождение и исследование артефактов.[/bold]
...
station-goal-bank =
    { "" }[bold]Второстепенная цель — постройка орбитального хранилища с припасами и технологиями.[/bold]
...
station-goal-zoo =
    { "" }[bold]Второстепенная цель — улучшение рекреации персонала станции.[/bold]
...
station-goal-mining-outpost =
    { "" }[bold]Второстепенная цель — постройка орбитального шахтёрского аванпоста.[/bold]
...
station-goal-tesla =
    { "" }[bold]Второстепенная цель — постройка генератора, основанного на тесле.[/bold]
...
station-goal-security =
    { "" }[bold]Второстепенная цель — постройка и снабжение тренировочного комплекса для Милиции, с последующей проверкой состава.[/bold]
...
station-goal-shuttle-med =
    { "" }[bold]Второстепенная цель — постройка пилотируемого медицинского шаттла.[/bold]
...
station-goal-shuttle-sec =
    { "" }[bold]Второстепенная цель — постройка пилотируемого десантного шаттла.[/bold]

    Шаттл должен соответствовать следующим требованиям:
    1. Обеспечен стабильным источником питания и резервной батареей СМЭС.
    2. Иметь возможность совершать следующие движения: крен, тангаж и рысканье.
    3. Доступ к используемому оборудованию внутри отсеков не должен быть затруднён.
    4. Иметь на борту места и снаряжение как минимум на пять офицеров милиции.
...
station-goal-shuttle-rnd =
    { "" }[bold]Второстепенная цель — постройка пилотируемого исследовательского шаттла.[/bold]
...
station-goal-shuttle-srv =
    { "" }[bold]Второстепенная цель — постройка пилотируемого пассажирского шаттла.[/bold]
...
station-goal-shuttle-emergency =
    { "" }[bold]Второстепенная цель — постройка пилотируемого спасательного шаттла.[/bold]
...
station-goal-theatre =
    { "" }[bold]Второстепенная цель — постройка театральной зоны.[/bold]
    ...
    В случае проведения тестового представления сервисный отдел станции будет вознагражден по прибытию на Станцию Генштаба.
    По окончании работ Генштаб может прислать представителя для проведения тестового представления.

station-goal-ai =
    { "" }[bold]Второстепенная цель — постройка автономного отсека ИИ.[/bold]
...
station-goal-botany =
    { "" }[bold]Второстепенная цель — постройка теплиц и выведение приспособленных к температуре растений.[/bold]
...
station-goal-bunker =
    { "" }[bold]Второстепенная цель — приспособить станцию к мощным гиперэнергетическим потокам.[/bold]
...
station-goal-delta-xeno-repair =
    { "" }[bold]Второстепенная цель — восстановление заброшенного ксенобиологического сектора научного отдела.[/bold]
...
station-goal-delta-ambusol =
    { "" }[bold]Второстепенная цель — восстановление заброшенного вирусологического сектора медицинского отдела.[/bold]
...
station-goal-split-secure =
    { "" }[bold]Второстепенная цель — обеспечить безопасность в субсекторе Split.[/bold]
...
station-goal-astra-repair =
    { "" }[bold]Второстепенная цель — восстановление заброшенной станции Vasilisk, находящейся в центральной части.[/bold]
