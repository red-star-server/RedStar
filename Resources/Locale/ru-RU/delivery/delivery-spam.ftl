...
delivery-spam-2 =   Причины выбрать СССП!
    .desc =         Реклама СССП.
    .content =      { -delivery-header-nanotrasen }
                    ...
                    ИХ МИРНЫЕ СОТРУДНИКИ УЯЗВИМЫ К ПУЛЯМ! ПОВЕРЬТЕ, МЫ ПРОВЕРЯЛИ! В ОТЛИЧИЕ ОТ СОТРУДНИКОВ СССП, МИРНЫЕ СОТРУДНИКИ СИНДИКАТА ДОХНУТ ОТ ОДНОЙ ПУЛИ В ЛОБ! А ПУЛИ У НАС ЕСТЬ!
...
delivery-spam-3 =   Причины выбрать Синдикат!
    ...
    .content =      { -delivery-header-syndicate }
                    ...
                    { "[bold]ПРИЧИНА ОДИН[/bold]" }
                    ИХ ОРУЖИЕ ОТСТОЙ! У НИХ НЕТ ДАЖЕ СНАЙПЕРСКИХ ВИНТОВОК! А ИХ МИЛИЦИЯ НЕ МОЖЕТ ДАЖЕ НОСИТЬ БОЛЬШИЕ ПУШКИ В БОЛЬШИНСТВЕ СИТУАЦИЙ!
...
delivery-spam-5 =   БЕСССПЛАТНЫЙ ПОЛНЫЙ ДОСТУП!!
    ...
    .content =      { "[head=3]Вы когда-нибудь мечтали о [italic][color=green]Бесссплатном [bold]Полном доссступе!?!?[/bold][/color][/italic][/head]" }
                    ...
                    { "[color=gray]" }
                    { "[bullet/]Примечание: Айди станции должено быть указано в формате \"USSP/NX — ###\"" }
...
delivery-spam-6 =   УВЕДОМЛЕНИЕ ОТ НАНАТРАЗЕН!!
    ...
    .content =      { "[color=red] ОФИЦИАЛНОЕ СООБЩЕНИЕ ГЛАВЫ [color=blue]НАНАТРАЗЕН[/color][/color]" }
                    ...
                    { "[head=2][color=red]ИГНОРИРОВАНИЕ ЭТОГО ПРИКАЗА ГРОЗИТ ВАМ КАРОЙ ОТ [color=green]ГЕНШТАБА[/color]!!!!![/head][/color]" }
...
delivery-spam-7 =   Отправьте подкрепление!
    ...
    .content =      { -delivery-header-nanotrasen-alternate-timeline }
                    { "[head=2]Это официальное уведомление [color=red]Начальника Милиции[/color] Космической станции 15 СССП.[/head]" }
