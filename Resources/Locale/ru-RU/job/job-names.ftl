...
job-name-security = офицер милиции
...
JobHeadOfSecurity = глава милиции
JobJanitor = уборщик
JobLawyer = адвокат
...
JobScientist = учёный
JobSecurityCadet = кадет милиции
JobSecurityOfficer = офицер милиции
