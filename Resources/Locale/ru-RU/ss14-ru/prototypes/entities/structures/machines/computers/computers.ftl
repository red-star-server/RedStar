...
ent-ComputerStationTeleportersControlFilled = { ent-ComputerStationTeleportersControl }
    ...
    .suffix = Авотзаполнение, сеть СССП
...
ent-CentcommComputerComms = консоль связи Генерального штаба
...
ent-ComputerCargoOrdersSecurity = милицейская консоль заказа грузов
