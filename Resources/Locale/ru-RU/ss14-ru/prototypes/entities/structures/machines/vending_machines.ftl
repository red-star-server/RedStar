...
ent-VendingMachineMedicalBase = СовМед Гражданский
    .desc = Это медицинский раздатчик препаратов. Только натуральные химикаты!
ent-VendingMachineMedical = СовМед Плюс
...
ent-VendingMachineSec = СБТех
    .desc = Торговый автомат с экипировкой милиции. На табличке написано "ТОЛЬКО ДЛЯ СОТРУДНИКОВ МИЛИЦИИ".
...
ent-VendingMachineSecDrobe = МилицШкаф
    .desc = Торговый автомат для одежды, связанной с милицией и безопасностью!
...
ent-VendingMachineDetDrobe = СледШкаф
    .desc = Машина для всех ваших нужд, как следователя, до тех пор, пока вам нужна одежда.
...
ent-VendingMachineWallMedicalCivilian = СовМед-Бандаж
    .desc = Это настенный раздатчик медицинского снаряжения. Только натуральные химикаты!
ent-VendingMachineWallMedical = СовМед
