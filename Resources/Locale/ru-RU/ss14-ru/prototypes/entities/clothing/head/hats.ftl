...
ent-ClothingHeadHatBeretSecurity = берет милиции
    .desc = Берет с эмблемой милиции. Для офицеров, которые предпочитают защите стиль.
ent-ClothingHeadHatSecurityTrooper = шляпа патрульного
    .desc = Широкополая шляпа Патрульных СССП. В комплекте ещё должен идти чехол...
...
ent-ClothingHeadHatBeretHoS = берет главы милиции
...
ent-ClothingHeadHatHoshat = шляпа главы милиции
    .desc = Стильная фуражка главы милиции. Показывает офицерам, кто здесь командует.
...
ent-ClothingHeadHatCentcomcap = фуражка Генштаба
    .desc = Экстравагантная, стильная фуражка офицера Генерального штаба. Показывает капитану, кто здесь командует.
