...
ent-ClothingNeckMantleHOS = мантия главы милиции
    .desc = Перестрелки с оперативниками — это просто очередной вторник для этого ГМ. Эта мантия — символ преданности станции.
