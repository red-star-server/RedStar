...
ent-ClothingOuterWinterHoP = зимняя куртка главы персонала
    .desc = { ent-ClothingOuterWinterCoatToggleable.desc }
ent-ClothingOuterWinterHoS = зимняя бронекуртка главы милиции
    .desc = Прочная, утилитарная зимняя куртка, предназначенная для защиты главы милиции от любых угроз, связанных с бригом и переохлаждением.
ent-ClothingOuterWinterHoSUnarmored = зимняя куртка главы милиции
