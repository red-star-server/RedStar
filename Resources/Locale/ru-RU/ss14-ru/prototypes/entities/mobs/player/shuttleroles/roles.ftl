...
ent-RandomHumanoidVisitorHOP = посетитель ГП роль призрака
    .desc = { "" }
ent-RandomHumanoidVisitorHOS = посетитель ГМ роль призрака
    .desc = { "" }
ent-RandomHumanoidVisitorRD = посетитель НР роль призрака
    .desc = { "" }
ent-RandomHumanoidVisitorQM = посетитель КМ роль призрака
    .desc = { "" }
ent-RandomHumanoidVisitorSecurityCadet = посетитель кадет милиции роль призрака
    .desc = { "" }
ent-RandomHumanoidVisitorSecurityOfficer = посетитель офицер милиции роль призрака
    .desc = { "" }
...
ent-RandomHumanoidVisitorLawyer = посетитель адвокат роль призрака
    .desc = { "" }
ent-RandomHumanoidVisitorLawyerCentcom = посетитель адвокат генштаба роль призрака
    .desc = { "" }
...
ent-RandomHumanoidChallengeVictimHOP = жертва катастрофы ГП роль призрака
    .desc = { ent-RandomHumanoidChallengeVictimCaptain.desc }
    .suffix = ЧЕЛЛЕНДЖ
ent-RandomHumanoidChallengeVictimHOS = жертва катастрофы ГМ роль призрака
    .desc = { ent-RandomHumanoidChallengeVictimCaptain.desc }
    .suffix = ЧЕЛЛЕНДЖ
