...
ent-BaseWeaponPowerCell = { ent-BaseItem }
    .desc = { ent-BaseItem.desc }
ent-BaseWeaponBatterySmallNoAmmoCounter = { ent-BaseWeaponBatteryNoAmmoCounter }
    .desc = { ent-BaseWeaponBatteryNoAmmoCounter.desc }
ent-BaseWeaponBatterySmall = { ent-BaseWeaponBatterySmallNoAmmoCounter }
    .desc = { ent-BaseWeaponBatterySmallNoAmmoCounter.desc }
...
ent-WeaponPulsePistol = импульсный пистолет
    .desc = Новейший энергетический пистолет, предпочитаемый оперативниками СССП в качестве запасного оружия.
ent-WeaponPulseCarbine = импульсный карабин
    .desc = Высокотехнологичный энергетический карабин, который предпочитают оперативники ОБР СССП.
...
ent-WeaponTaserSuper = элитный тазер
    .desc = Электрошокер малой ёмкости, используемый элитным отрядом милиции для обезвреживания даже самых стойких целей.
    .suffix = АДМЕМЫ
...
ent-WeaponEnergyMagnum = энергетический магнум
    .desc = Мощный самозаряжающийся энергетический пистолет, разработанный для элитных сотрудников милиции. Имеет три режима стрельбы, позволяющие нелетально обезвреживать, стрелять через окна, или наносить высокий урон.
