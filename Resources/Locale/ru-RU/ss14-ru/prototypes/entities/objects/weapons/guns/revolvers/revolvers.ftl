...
ent-WeaponRevolverInspector = Инспектор
    .desc = Револьвер двойного действия, выпускаемый различными производителями. Свободно продаётся на гражданском рынке, из-за чего пользуется популярностью среди частных следователей. Просто держа его в руках чувствуешь, как тебе везёт. Вмещает 6 патронов калибра .45 магнум.
ent-WeaponRevolverMateba = Матеба
    .desc = Современный револьвер, используемый элитным, почти мифическим отрядом быстрого реагирования "Эскадрон Смерти" корпорации СССП. Уникальный спусковой механизм и расположение ствола обеспечивают высокую скорострельность при минимальной отдаче. Многие заглядывали в этот ствол — но немногие смогли потом об этом рассказать. Вмещает 6 патронов калибра .45 магнум.
