...
ent-WeaponFlareGunSecurity = сигнальное ружьё
    .desc = Модифицированный сигнальный пистолет, изначально предназначенный для использования милицией для запуска нелетальных ружейных снарядов. Однако он также может без риска стрелять и летальными снарядами.
