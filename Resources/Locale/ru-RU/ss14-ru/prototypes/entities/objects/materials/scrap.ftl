...
ent-ScrapFaxMachine = факс
    .desc = Печальный результат слишком большого количества ASCII-артов, отправленных Генштабу.
    .suffix = { ent-BaseScrap.suffix }
...
ent-ScrapMopBucket = половина ведра для швабры
    ...
    .suffix = { ent-BaseScrap.suffix }
ent-ScrapTarget = окровавленная мишень
    .desc = Похоже, что-то помешало достижению его цели.
    .suffix = { ent-BaseScrap.suffix }
