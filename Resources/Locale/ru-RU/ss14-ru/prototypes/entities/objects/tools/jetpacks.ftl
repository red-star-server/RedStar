...
ent-JetpackMiniFilled = мини-джетпак
    ...
    .suffix = Полный
ent-JetpackSecurity = мини-джетпак милиции
    .desc = Компактный реактивный ранец, используемый милиции станции при патрулировании внешней территории станции. Не предназначен для дальних перелётов, вмещает только 1,5 л топлива.
    .suffix = Пустой
