...
ent-NanotrasenFlippo = флиппо СССП
...
ent-CentCommFlippo = позолоченная флиппо Генштаба
    .desc = Изысканная флиппо, с рельефным, нефритовым с позолотой корпусом, турбо-пламя которой создаётся блюспейсом. Кнопка защищена миниатюрным считывателем доступов, который реагирует только на сотрудников Генштаба. Самая красивая зажигалка, известная человечеству.
    .suffix = НЕ МАППИТЬ
