...
ent-CigPackMixed = пачка пропитанных сигарет Дениса
    .desc = Ларек Дениса работал с химическим предприятием СССП в области утилизации избытка химикатов, НАСЛАЖДАЙТЕСЬ.
    .suffix = Смешанные
