...
ent-FakeMindShieldImplant = имплант "фальшивый Щит разума"
    .desc = Этот имплант позволяет имплантеру генерировать фальшивый сигнал, по которому милицейские визоры СССП идентифицируют людей, имплантированных Щитом разума.
...
ent-DeathRattleImplantCentcomm = имплант "предсмертный хрип" Генштаба
