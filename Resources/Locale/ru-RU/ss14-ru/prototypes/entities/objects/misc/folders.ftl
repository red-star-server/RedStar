...
ent-BoxFolderCentComEmpty = папка Генштаба
...
ent-BoxFolderPlasticClipboardThreePapers = { ent-BoxFolderPlasticClipboardEmpty }
    .desc = { ent-BoxFolderPlasticClipboardEmpty.desc }
    .suffix = { ent-BoxFolderFillThreePapers.suffix }
ent-BoxFolderCentComClipboardEmpty = планшет Генштаба
    .desc = Роскошный планшет, обитый зелёным бархатом. Представители Генштаба часто носят его с собой, но редко используют.
