...
ent-CargoRequestSecurityComputerCircuitboard = милицейская консоль заказа грузов (консольная плата)
    .desc = Консольная плата для милицейская консоли заказа грузов.
...
ent-CentcommCommsComputerCircuitboard = консоль связи Генерального штаба (консольная плата)
