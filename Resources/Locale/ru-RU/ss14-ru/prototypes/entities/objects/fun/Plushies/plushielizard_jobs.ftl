...
ent-PlushieLizardJobSecuritycadet = плюшевая ящерица кадет милиции
    .desc = Очаровательная мягкая игрушка, напоминающая ящерицу кадета милиции. Похоже, на ней следы от электрических ожогов.
ent-PlushieLizardJobSecurityofficer = плюшевая ящерица офицер милиции
    .desc = Очаровательная мягкая игрушка, напоминающая ящерицу офицера милиции. Наполнитель утрамбовался от множества ударов.
