...
ent-VendingMachineRestockCostumes = набор пополнения ТеатроШкаф
    .desc = Паноптикум рабочих СССП пестрит в красочной трагикомедии. Присоединяйтесь к ним и вы! Загрузите это в ближайший торгомат ТеатроШкаф.
...
ent-VendingMachineRestockMedical = набор пополнения СовМед
    .desc = Поместите в СовМед или СовМед Плюс вашего отдела для пополнения. Не кантовать.
