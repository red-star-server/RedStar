...
ent-SyndiHypo = горлекс гипоспрей
    .desc = Стерильный инъектор для быстрого введения медикаментов. С помощью реверс-инжиниринга технологии СССП, Cybersun выпускает их в ограниченном количестве для медиков Мародёров Горлекса.
