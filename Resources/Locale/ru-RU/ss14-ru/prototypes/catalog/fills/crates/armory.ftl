...
ent-CrateArmoryShotgun = ящик дробовиков
    ...
    .suffix = { ent-CrateWeaponSecure.suffix }
ent-CrateArmoryMosin = ящик винтовок Мосина
    .desc = Надёжные, до смешного дешёвые и чертовски громкие. Содержит три винтовки Мосина и 12 спидлоадеров патронов калибра .30. Чтобы открыть, необходим доступ уровня Оружейной.
    .suffix = { ent-CrateWeaponSecure.suffix }
