...
ent-KillRandomHeadObjective = { ent-BaseTraitorObjective }
    .desc = Нам нужно, чтобы этот глава исчез, и вы, вероятно, знаете, почему. Убедитесь, что глава не попадёт на Генштаб даже в мёртвом виде. Удачи, агент.
ent-KillStationAiObjective = { ent-BaseTraitorObjective }
    .desc = СССП с гордостью заявляет о своей передовой технологии искусственного интеллекта. Напомните им, что это всего лишь игрушка, которую можно сломать.
...
ent-SupercritAnomaliesObjective = { ent-BaseTraitorObjective }
    .desc = СССП проявляет большой интерес к аномалиям, которые могут иметь потенциально катастрофические последствия. Познакомьте их с огнем, с которым они играют.
...
ent-MailFraudObjective = { ent-BaseTraitorObjective }
    .desc = Нас интересует корреспонденция СССП. Инструмент для вскрытия писем не прилагается.
