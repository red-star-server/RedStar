...
ent-ShippingContainerNanotrasen = грузовой контейнер СССП
    .desc = Контейнер стандартного размера для транспортировки больших объёмов грузов. На этом контейнере изображён логотип СССП, и поэтому внутри может быть что угодно.
