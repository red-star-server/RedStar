...
public sealed partial class TTSSystem
{
    ...
    /// </summary>
    private (EntityUid Effect, EntityUid Auxiliary)? TryCreateEffectWithAuxiliary(
    ...
    private bool EnsureVoiceEffectInitialized()
    {
        ...
        lock (_voiceEffectLock)
        {
            ...
            var result = TryCreateEffectWithAuxiliary(
                GetVoicePreset(_voiceEffectPreset),
                $"voice ({_voiceEffectPreset})");
