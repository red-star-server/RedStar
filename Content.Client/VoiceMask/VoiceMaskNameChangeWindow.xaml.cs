...
public sealed partial class VoiceMaskNameChangeWindow : FancyWindow
{
    ...
    public Action<ProtoId<TTSVoicePrototype>>? OnVoiceChange; // Corvax-TTS
    ...
    public void UpdateState(string name, string? verb, bool active, bool accentHide, LocId titleText, ProtoId<TTSVoicePrototype> voice) // Corvax-TTS
    {
